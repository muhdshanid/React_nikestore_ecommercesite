    ...
    <footer className='bg-theme pt-7 pb-5 '>
        <div className='nike-container text-slate-100'>
            ...
            <div className='mt-5 text-center '>
                <p 
                className='text-sm md:text-center'>Copyright
                <sup className='text-base font-bold'>&copy;</sup>All Reserved Rights 2022 
                <span className='font-semibold'> MSHANI DEV</span></p>
            </div>
        </div>
    </footer>
    </>
