        ...
        <div className='flex items-center justify-between w-full px-5'>
            <div className='flex items-center gap-5'>
                ...
                hover:scale-105 transition-all duration-700 ease-in-out grid items-center`}>
                    ...
                    <div className='absolute right-1 top-1 blur-effect-theme bg-white/80
                    text-black text-xs px-1 rounded font-medium'>${price}</div>
                </div>
                <div className='grid items-center gap-4'>
                    ...
                    <div className='flex items-center justify-around w-full '>
                        <button type='button' className='bg-theme-cart rounded w-6 h-6 lg:w-5 lg:h-5 flex items-center justify-center active:scale-90' onClick={onDecreaseItemQTY}><MinusIcon className='w-5 h-5 lg:w-4 lg:h-4 text-white
                        storke-[2]'/></button>
                        <div className='bg-theme-cart rounded text-white font-medium lg:text-xs w-7 h-6 
                        lg:h-5 lg:w-6 flex items-center justify-center'>{cartQuantity}</div>
                        <button type='button' onClick={onIncreaseItemQTY} className='bg-theme-cart rounded w-6 h-6 lg:w-5 lg:h-5 flex items-center justify-center active:scale-90'><PlusIcon className='w-5 h-5 lg:w-4 lg:h-4 text-white
                        storke-[2]'/></button>
            ...
            <div className='grid items-center gap-5'>
                ...
                <div className=''>
                    <button type='button' className='bg-theme-cart rounded p-1 lg:p-0.5 grid items-center justify-center cursor-pointer' onClick={onRemoveItem}>
